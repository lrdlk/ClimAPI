...
class IDEAMRadarVisualizer:
    ...
    def __init__(self, data_dir="data/Radar_IDEAM"):
        ...
        # Productos disponibles de radar
        self.productos_radar = {
            'reflectivity': {'nombre': 'Reflectividad', 'unidad': 'dBZ', 'vmin': -20, 'vmax': 70},
            'velocity': {'nombre': 'Velocidad Radial', 'unidad': 'm/s', 'vmin': -30, 'vmax': 30},
            'spectrum_width': {'nombre': 'Ancho Espectral', 'unidad': 'm/s', 'vmin': 0, 'vmax': 10}
        }
